                                                            ...
                                                            <table id="example" class="display" style="width:100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <!-- <td>{{$a->status}}</td> -->
                                                                        <td>
                                                                        <a href="{{route('gallery_details.edit',$a->id)}}"><button class="btn btn-primary">Update</button></a>
                                                                            <form action="{{route('gallery_details.destroy',$a->id)}}" method="post" style="margin-top:5%;">
                                                                            @csrf
                                                                            @method('DELETE')
