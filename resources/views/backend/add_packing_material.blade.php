                                                ...
                                                <div class="white_card card_height_100 mb_30">
                                                    <div class="white_card_header">
                                                        <div class="box_header m-0">
                                                            <div class="main-title">
                                                                <h3 class="m-0">Packing Method Form</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="white_card_body">
                                                        <div class="card-body">
                                                            ...
                                                            <form method="post" action="{{route('packing_material_details.store')}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputEmail4">Title</label>
                                                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Title" name="name" required>
                                                                    </div>
                                                                    <div class="form-group col-md-6">
