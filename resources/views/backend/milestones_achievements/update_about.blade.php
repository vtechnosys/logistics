                                                    ...
                                                    <div class="white_card_header">
                                                        <div class="box_header m-0">
                                                            <div class="main-title">
                                                                <h3 class="m-0">Edit Milestones Achievements Form</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <form method="post" action="{{route('milestones_achievements_details.update',$about->id)}}" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputEmail4">Year Of Ochievement</label>
                                                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Name" value="{{$about->year}}" name="name">
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea type="text" class="form-control" placeholder="Description" id="summernote" rows="10" name="desc"  value="{{$about->description}}">{{$about->description}}</textarea>
                                                                </div>
