                                                ...
                                                <div class="white_card card_height_100 mb_30">
                                                    <div class="white_card_header">
                                                        <div class="box_header m-0">
                                                            <div class="main-title">
                                                                <h3 class="m-0">Moving Tips Form</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="white_card_body">
                                                        <div class="card-body">
                                                            ...
                                                            <form method="post" action="{{route('packing_material_details.update',$about->id)}}" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PATCH')
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputEmail4">Name</label>
                                                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Title" value="{{$about->title}}" name="name">
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputPassword4">Image</label>
                                                                        <input type="file" class="form-control" id="inputPassword4" placeholder="Password" name="file" >
                                                                        <center><img src="{{asset('backend/image')}}/{{$about->img}}" height="50px" width="80px" style="margin-top:20px;"></center>
                                                                    </div>
                                                                </div>
