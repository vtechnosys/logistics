                                                ...
                                                <div class="white_card card_height_100 mb_30">
                                                    ...
                                                    <div class="white_card_body">
                                                        <div class="card-body">
                                                            ...
                                                            <form method="post" action="{{route('service_details.update',$about->id)}}" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PATCH')
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <center><img src="{{asset('backend/image')}}/{{$about->image}}" height="50px" width="80px" style="margin-top:20px;"></center>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputAddress">Short Description</label>
                                                                    <textarea type="text" class="form-control" id="summernote" placeholder="Description"  rows="10" name="short_desc"  value="{{$about->description}}">{{$about->short_description}}</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputAddress">Description</label>
                                                                    <textarea type="text" class="form-control" id="summernote1" placeholder="Description"  rows="10" name="desc"  value="{{$about->description}}">{{$about->description}}</textarea>
                                                                </div>
