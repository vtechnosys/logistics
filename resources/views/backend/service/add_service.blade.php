                                                ...
                                                <div class="white_card card_height_100 mb_30">
                                                    ...
                                                    <div class="white_card_body">
                                                        <div class="card-body">
                                                            ...
                                                            <form method="post" action="{{route('service_details.store')}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea type="text" class="form-control" id="summernote" placeholder="Description" rows="10" name="short_desc" required></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputAddress">Description</label>
                                                                    <textarea type="text" class="form-control" id="summernote1" placeholder="Description" rows="10" name="desc" required></textarea>
                                                                </div>
