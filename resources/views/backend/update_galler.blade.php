                                                ...
                                                <div class="white_card card_height_100 mb_30">
                                                    ...
                                                    <div class="white_card_body">
                                                        <div class="card-body">
                                                            ...
                                                            <form method="post" action="{{route('gallery_details.update',$gallery->id)}}" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PATCH')
                                                                <div class="form-row">
                                                                    <img src="{{asset('backend/image')}}/{{$gallery->image}}" height="100px" width="100px">
